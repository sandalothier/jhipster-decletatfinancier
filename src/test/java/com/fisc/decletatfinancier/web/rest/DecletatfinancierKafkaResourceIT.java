...
import com.fisc.decletatfinancier.DecletatfinancierApp;
...
@SpringBootTest(classes = DecletatfinancierApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecletatfinancierKafkaResourceIT {
    ...
    @Autowired
    private DecletatfinancierKafkaProducer producer;

    @Autowired
    private DecletatfinancierKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecletatfinancierKafkaResource kafkaResource = new DecletatfinancierKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-kafka/publish?message=test"))
