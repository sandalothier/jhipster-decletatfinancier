package com.fisc.decletatfinancier.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("decletatfinancier");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("decletatfinancier");
        ...
        config.getMapConfigs().put("com.fisc.decletatfinancier.domain.*", initializeDomainMapConfig(jHipsterProperties));
